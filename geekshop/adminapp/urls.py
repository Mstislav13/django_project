...
from adminapp.views import UsersListView, UserCreateView, UserUpdateView, UserDeleteView, CategoryDeleteView,\
    CategoryListView, CategoryCreateView, CategoryUpdateView, ProductsListView, ProductDeleteView,\
    ProductDetailView
