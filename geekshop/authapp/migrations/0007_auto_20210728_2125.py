...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authapp', '0006_auto_20210728_1925'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 7, 30, 21, 25, 23, 182444)),
        ),
        migrations.CreateModel(
            name='ShopUserProfile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tag_line', models.CharField(blank=True, max_length=120, verbose_name='тэги')),
